...
#define KS1_CRYPTO_SECRETKEYBYTES 90
#define KS1_CRYPTO_PUBLICKEYBYTES 62
#define KS1_CRYPTO_BYTES 32

// Change the algorithm name
#define KS1_CRYPTO_ALGNAME "KAZ-SIGN-1"

// liboqs API
int kaz_sign_1_ref_keypair(unsigned char *pk, unsigned char *sk);

int kaz_sign_1_ref_signature(unsigned char *sm, unsigned int *smlen,
                             const unsigned char *m, unsigned int mlen,
                             const unsigned char *sk);

int kaz_sign_1_ref_verify(const unsigned char *sm, unsigned int smlen,
                          const unsigned char *m, unsigned int mlen,
