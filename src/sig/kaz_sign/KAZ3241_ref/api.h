...
#define KS5_CRYPTO_SECRETKEYBYTES 176
#define KS5_CRYPTO_PUBLICKEYBYTES 106
#define KS5_CRYPTO_BYTES 32

// Change the algorithm name
#define KS5_CRYPTO_ALGNAME "KAZ-SIGN-5"
...
// liboqs API
int kaz_sign_5_ref_keypair(unsigned char *pk, unsigned char *sk);

int kaz_sign_5_ref_signature(unsigned char *sm, unsigned int *smlen,
                             const unsigned char *m, unsigned int mlen,
                             const unsigned char *sk);

int kaz_sign_5_ref_verify(const unsigned char *sm, unsigned int smlen,
                          const unsigned char *m, unsigned int mlen,
                          const unsigned char *pk);
