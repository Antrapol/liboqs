...
// liboqs API
int kaz_sign_3_ref_keypair(unsigned char *pk, unsigned char *sk);

int kaz_sign_3_ref_signature(unsigned char *sm, unsigned int *smlen,
                             const unsigned char *m, unsigned int mlen,
                             const unsigned char *sk);

int kaz_sign_3_ref_verify(const unsigned char *sm, unsigned int smlen,
                          const unsigned char *m, unsigned int mlen,
                          const unsigned char *pk);
