...
OQS_API const char *OQS_SIG_alg_identifier(size_t i) {
  ...
  const char *a[OQS_SIG_algs_length] = {
      ...
      /// KAZ-SIGN family
      OQS_SIG_alg_kaz_sign_1,
      OQS_SIG_alg_kaz_sign_3,
      OQS_SIG_alg_kaz_sign_5,
  };
...
OQS_API int OQS_SIG_alg_count(void) { return OQS_SIG_algs_length; }
...
OQS_API int OQS_SIG_alg_is_enabled(const char *method_name) {
  ...
  if (0) {
    ...
    return 0;
             ...
             strcasecmp(method_name, OQS_SIG_alg_sphincs_sha2_128f_simple)) {
    ...
    return 0;
             ...
             strcasecmp(method_name, OQS_SIG_alg_sphincs_sha2_128s_simple)) {
    ...
    return 0;
             ...
             strcasecmp(method_name, OQS_SIG_alg_sphincs_sha2_192f_simple)) {
    ...
    return 0;
             ...
             strcasecmp(method_name, OQS_SIG_alg_sphincs_sha2_192s_simple)) {
    ...
    return 0;
             ...
             strcasecmp(method_name, OQS_SIG_alg_sphincs_sha2_256f_simple)) {
    ...
    return 0;
             ...
             strcasecmp(method_name, OQS_SIG_alg_sphincs_sha2_256s_simple)) {
    ...
    return 0;
             ...
             strcasecmp(method_name, OQS_SIG_alg_sphincs_shake_128f_simple)) {
    ...
    return 0;
             ...
             strcasecmp(method_name, OQS_SIG_alg_sphincs_shake_128s_simple)) {
    ...
    return 0;
             ...
             strcasecmp(method_name, OQS_SIG_alg_sphincs_shake_192f_simple)) {
    ...
    return 0;
             ...
             strcasecmp(method_name, OQS_SIG_alg_sphincs_shake_192s_simple)) {
    ...
    return 0;
             ...
             strcasecmp(method_name, OQS_SIG_alg_sphincs_shake_256f_simple)) {
    ...
    return 0;
             ...
             strcasecmp(method_name, OQS_SIG_alg_sphincs_shake_256s_simple)) {
  ...
  } else if (0 == strcasecmp(method_name, OQS_SIG_alg_kaz_sign_1)) {
#ifdef OQS_ENABLE_SIG_kaz_sign_1
    return 1;
#else
    return 0;
#endif
  } else if (0 == strcasecmp(method_name, OQS_SIG_alg_kaz_sign_3)) {
#ifdef OQS_ENABLE_SIG_kaz_sign_3
    return 1;
#else
    return 0;
#endif
  } else if (0 == strcasecmp(method_name, OQS_SIG_alg_kaz_sign_5)) {
#ifdef OQS_ENABLE_SIG_kaz_sign_5
    return 1;
#else
    return 0;
#endif
...
OQS_API OQS_STATUS OQS_SIG_verify(const OQS_SIG *sig, const uint8_t *message,
  ...
  if (sig == NULL || sig->verify(message, message_len, signature, signature_len,
...
OQS_API void OQS_SIG_free(OQS_SIG *sig) { OQS_MEM_insecure_free(sig); }
